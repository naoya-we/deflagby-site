...
function defragby_scripts() {
  ...
  // Main stylesheet
  wp_enqueue_style( 'defragby-style', get_stylesheet_uri(), array(), '7.5.0' );

  // Theme components & layout styles
  wp_enqueue_style( 'defragby-main', get_template_directory_uri() . '/assets/css/main.css', array( 'defragby-style' ), '7.5.0' );
